...
var part4 = {
    ...
    instruction1: function () {
        ...
        var result = properties.name + " zit in " + properties.group + " en heeft " + properties.lessons;
    ...
    instruction2: function () {
        ...
        // Zorg ervoor dat de opdracht goed wordt uitgevoerd en dat de content wordt bijgewerkt.
        var result = '[{"name":"Yosef East","group":"MD2A"}, {"name":"Madison Dillard","group":"MD2A"}, {"name":"Thiago Sherman","group":"MD2A"}, {"name":"Iga Mcgee","gr';
    ...
    instruction3: function () {
        ...
        updateContent("Opdracht 14 - public API", description, result);
    },
